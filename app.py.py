...
try:
    ...
    def qa_pipeline(input_dict):
        return {
            "answer": "I'm sorry, I can’t answer that specifically, but I can help with SkillHigh course or platform info!"
        }
...
faq_data = {
    "internship": "SkillHigh (or Skillintern) is an online training and internship platform. It offers short online courses with live and recorded classes. After training, students work on live projects for practical experience.",
...
small_talk = {
    ...
    "good morning": "Good morning! ☀️ Ready to learn something new today?",
